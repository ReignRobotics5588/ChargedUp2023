...
public class ArmSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Upper Arm Position (?)", m_upperJointEncoder.getPosition()); // number of rotations in the motor
    SmartDashboard.putNumber("Lower Arm Position (?)", m_lowerJointEncoder.getPosition());
